  ...
  return (
    <div className="mx-auto mt-16 max-w-md">
      <div className="rounded-2xl border border-cream-200 bg-white/80 p-8 shadow-sm backdrop-blur">
        <h1 className="font-display text-3xl text-olive-900">처음 오셨군요</h1>
        <p className="mt-2 text-sm text-sage-700">이메일과 비밀번호로 계정을 만들 수 있어요.</p>
        ...
        >
          ...
          {info ? (
            <p className="rounded-md bg-sage-300/20 px-3 py-2 text-sm text-sage-700">{info}</p>
          ) : null}
